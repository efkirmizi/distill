...
def debiased_dot_product_similarity_helper(
...
def feature_space_linear_cka(features_x, features_y, debiased=False):
  ...
  if debiased:
    ...
    dot_product_similarity = debiased_dot_product_similarity_helper(
        dot_product_similarity, sum_squared_rows_x, sum_squared_rows_y,
        squared_norm_x, squared_norm_y, n)
    normalization_x = np.sqrt(debiased_dot_product_similarity_helper(
        normalization_x ** 2, sum_squared_rows_x, sum_squared_rows_x,
        squared_norm_x, squared_norm_x, n))
    normalization_y = np.sqrt(debiased_dot_product_similarity_helper(
...
def r2_cca(features_x, features_y):
